...
class SlackUserResult(BaseModel):
    id: str = Field(
        description="The unique Slack user ID."
    )
    user_name: str = Field(
        description="The unique slack username."
    )
...
class AgentContext(BaseModel):
    ...
    memories: list[Memory] | None = Field(None, description="An id:content map of the user's memories for this bot")
    slack_user_metadata: SlackUserResult = Field(None, description="The metadata for the user's slack profile.")
